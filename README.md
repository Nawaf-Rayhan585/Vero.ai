...
Once both are running, the app shows **Sign in**; click **Create one** the first time to register — this creates your account, your organization (you're its Owner), a default location, and (only for the very first account ever registered) adopts any cameras/jobs already in the database into that organization. Add more people to your organization from **Account** once they've registered their own account (there is no invitation email yet).
