...
- Accounts and organizations live in this same local backend/PostgreSQL, not a separate cloud service — `docs/ARCHITECTURE.md`'s target puts Auth in "Vero.ai Cloud" (Phase 13 decides how Own Hardware accounts relate to that once it exists; Phase 12 deliberately left them local).
